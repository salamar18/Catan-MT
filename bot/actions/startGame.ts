 ...
 *
 * Assumes the user is already logged in and the lobby has loaded with the
 * default game mode (Casual 1v1). Configures a private 1v1 vs bot with ranked-style settings.
 */
